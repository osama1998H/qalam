...
export default function App() {
  ...
  const handleSave = useCallback(async () => {
    ...
    const result = await window.qalam.file.save(activeTab.filePath, activeTab.content)
    if (result.success) {
  ...
  }, [nextTab, prevTab, activeTab, handleCloseTab, handleNew, handleOpenFind, handleOpenReplace, handleCloseFind, showFind, showGoToLine, showQuickOpen, showSettings, showProblems])
